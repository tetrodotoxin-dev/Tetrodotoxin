  ...
  return Query(
      {this,
       [](const void* source, perimortem_uuid requested,
         ...
         auto& reader = *const_cast<Validation::FlowTests::Reader*>(
             static_cast<const Validation::FlowTests::Reader*>(source));
         ...
         if (id == Direct::View::contract_id) {
           ...
           return static_cast<ttx_binding_status>(
               Binding::provide<Direct::View>(
                   Direct::View::Api(source, &direct),
           ...
           return static_cast<ttx_binding_status>(
               Binding::provide<Shared::View>(
                   Shared::View::Api(source, &shared),
                   Ttx::Data::Form::Storage(result)));
           ...
           return static_cast<ttx_binding_status>(
               Binding::provide<Fragment::View>(
                   Fragment::View::Api(source, &fragment),
                   Ttx::Data::Form::Storage(result)));
         } else {
       ...
       [](const void* source, perimortem_uuid requested) -> ttx_binding_status {
         const auto& reader = *static_cast<const Reader*>(source);
         const Perimortem::System::Uuid id(requested);
         U8 protocol = 0;
         if (id == Direct::View::contract_id) {
