...
static const ttx_schema four =
    {16, 4, TTX_SCHEMA_RANGE, {.range = {{&u32, 0}, 4, 4}}};
...
static const ttx_schema query_uuid = {
  sizeof(perimortem_uuid), _Alignof(perimortem_uuid), TTX_SCHEMA_COMPOSITE,
  {.composite = {uuid_fields, 2}}};
static const ttx_schema_position representation_fields[] = {
  {{&query_byte, TTX_SCHEMA_REFERENCE_POINTER}, offsetof(ttx_representation, data)},
  {{&query_count, 0}, offsetof(ttx_representation, size)}};
static const ttx_schema query_form = {
  sizeof(ttx_representation), _Alignof(ttx_representation), TTX_SCHEMA_COMPOSITE,
  {.composite = {representation_fields, 2}}};
static const ttx_schema_position storage_fields[] = {
  {{&query_form, TTX_SCHEMA_REFERENCE_POINTER}, offsetof(ttx_storage, representation)},
...
static const ttx_schema query_storage = {
  sizeof(ttx_storage), _Alignof(ttx_storage), TTX_SCHEMA_COMPOSITE,
...
static const ttx_schema two =
    {8, 4, TTX_SCHEMA_RANGE, {.range = {{&u32, 0}, 2, 4}}};
